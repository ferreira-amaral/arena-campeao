...
@RestController
@RequestMapping("/api/arena-campeao-kafka")
public class ArenaCampeaoKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ArenaCampeaoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ArenaCampeaoKafkaResource(KafkaProperties kafkaProperties) {
