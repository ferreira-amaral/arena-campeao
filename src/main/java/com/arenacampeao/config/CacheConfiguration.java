package com.arenacampeao.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("arenaCampeao");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("arenaCampeao");
        ...
        config.getMapConfigs().put("com.arenacampeao.domain.*", initializeDomainMapConfig(jHipsterProperties));
